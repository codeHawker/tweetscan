    ...
    return(
        ...
        <div className='about-box'>
          <div className='about-info'>
            ...
            <p>TweetScan shows you the most recent Tweets related to your search term, the most reTweeted, the most shared and also analyses the most frequently used terms</p>
